...
function buildFirefox() {
  ...
  execSync(`cd ${firefoxDir} && web-ext build --overwrite-dest --artifacts-dir ${distDir}`);
  
  // Rename the generated zip file
  const webExtOutput = fs.readdirSync(distDir).find(file => file.startsWith('web-ext-artifacts'));
  if (webExtOutput) {
